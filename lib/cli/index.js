...
program
  .command('fixture')
  .description('Execute WordPress CLI fixture command.')
  .option('<fixture>', 'The name of the fixture to run.')
  .option('<options>', 'The options of the fixture to run.')
  .option('-u, --update', 'Update a fixture data.')
  .action((options) => {
    ...
    wp(`fixture ${options.args.join(' ')} ${updateFlag}`, packageDir, logFile);
  });
